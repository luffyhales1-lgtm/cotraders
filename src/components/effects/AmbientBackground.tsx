  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{ top: '-6rem', left: '-4rem', width: '22rem', height: '22rem', background: 'radial-gradient(circle, hsl(243 82% 62% / 0.30), transparent 70%)' }}
      />
      <div
        className="ambient-orb"
        style={{ top: '20%', right: '-6rem', width: '24rem', height: '24rem', background: 'radial-gradient(circle, hsl(199 89% 55% / 0.24), transparent 70%)' }}
      />
      <div
        className="ambient-orb"
        style={{ bottom: '-8rem', left: '30%', width: '26rem', height: '26rem', background: 'radial-gradient(circle, hsl(262 80% 62% / 0.22), transparent 70%)' }}
      />
    </div>
  );
};
